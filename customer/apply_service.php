...
<?php
	...
	if($leave_days < 0)
	{
	  ...
	  elseif($num_days >= $leave_days )
      {
        ...
        echo "<script>alert('you have exceed the number of available days for your permission');</script>";
	  }
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Apply for Service</li>
								</ol>
							</nav>
						</div>
					</div>
						...
						<form method="post" action="">
							<section>
								...
								<div class="row">
									...
									<div class="col-md-6 col-sm-12">
										...
										<div class="form-group">
											...
											<input name="CustomerAddress" type="text" class="form-control" readonly required="true" autocomplete="off" value="<?php echo $row['LastName']; ?>">
										</div>
										<div class="col-md-6 col-sm-12">
										<div class="form-group">
											<label >Vehicle ID </label>
											<input name="vehicleId" type="text" class="form-control" readonly required="true" autocomplete="off" value="<?php echo $row['LastName']; ?>">
										</div>
										<div class="col-md-6 col-sm-12">
										<div class="form-group">
											<label >Vehicle type </label>
											<input name="vehicleType" type="text" class="form-control" readonly required="true" autocomplete="off" value="<?php echo $row['LastName']; ?>">
										</div>
										<div class="col-md-6 col-sm-12">
										<div class="form-group">
											<label >Service Type </label>
											<input name="serviceType" type="text" class="form-control" readonly required="true" autocomplete="off" value="<?php echo $row['LastName']; ?>">
										</div>
										<div class="col-md-6 col-sm-12">
										<div class="form-group">
										...
										<div class="form-group">
											<label >payment </label>
											<input name="payment" type="text" class="form-control" readonly required="true" autocomplete="off" value="<?php echo $row['LastName']; ?>">
										</div>
								...
								<div class="row">
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group">
											<label>Available Service Days </label>
								...
								<div class="row">
									<div class="col-md-6 col-sm-12">
										<div class="form-group">
											...
											<input id="datepicker" name="date_from" type="text" class="form-control date-picker" required="true" autocomplete="off">
										</div>
									</div>
									<div class="col-md-6 col-sm-12">
										<div class="form-group">
											<label>End Leave Date gryy :</label>
											<input id="datepicker" name="date_to" type="text" class="form-control date-picker" required="true" autocomplete="off">
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<div class="modal-footer justify-content-center">
												<button class="btn btn-primary" name="apply" id="apply" data-toggle="modal">Apply&nbsp;Service</button>
											</div>
										</div>
									</div>
								</div>
