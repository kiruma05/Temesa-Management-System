	...
	<div class="main-container">
		<div class="pd-ltr-20">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30" id="container">
					<div class="clearfix">
					<div class="pull-left">
							<h4 class="text-blue h4">Service Details</h4>
							<p class="mb-20"></p>
						</div>
					</div>
					<form method="post" action="" id="myfrm">
					<center><p><b>STAFF LEAVE FORM<b></p></center>
						<?php 
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<label style="font-size:16px;"><b>Service Status From HOD</b></label>
			...
			<p align="center"><input type="button" onclick="myPrint('myfrm')" value="print form" class="selectpicker form-control" style="background-color: pink; color: black; font-size: 22px;"></p>
				</div>
