...
<?php 
	 if (isset($_GET['delete'])) {
		...
		$sql = "DELETE FROM tbservice where id = ".$id;
		$result = mysqli_query($conn, $sql);
		if ($result) {
			echo "<script>alert('ServiceType deleted Successfully');</script>";
     		echo "<script type='text/javascript'> document.location = 'service_type.php'; </script>";
