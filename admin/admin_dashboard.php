...
<div class="pre-loader">
	...
	<div>
	<h1  class="card-box pd-20 height-100-p mb-30"><img src="../vendors/images/TEMELOGO.JPG" alt="">      Temesa Organization Management System (TOMS)</h1>
</div>
		<div class="pd-ltr-20">
				...
				<div class="col-md-4 user-icon">
					...
					<div class="col-md-8">
						...
						<h4 class="font-20 weight-500 mb-10 text-capitalize">
							Welcome back <div class="weight-600 font-30 text-blue"><?php echo $row['FirstName']. " " .$row['LastName']. ", " .$row['role']; ?>.</div>
						</h4>
						<p class="font-18 max-width-600">The Tanzania Technical and Electrical Agency (TEMESA) is a Public Institution established by the Government Agency Act Chapter 245. Its main responsibilities are to provide Vehicle and Mechanical Maintenance Services, Electrical Services including repairing Road Lights, Repairing Refrigerators, Air Conditioners and Repairing IT Systems and Electronic Equipment, providing Ferry Services and Consulting Services.</p>
					</div>
				</div>
			</div>
				...
				<div class="col-xl-6 col-lg-6 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark"><?php echo($empcount);?></div>
								<div class="font-14 text-secondary weight-500">Total Customer</div>
							</div>
							<div class="widget-icon">
								<div class="icon" data-color="#00eccf"><i class="icon-copy dw dw-user-2"></i></div>
							</div>
    ...
    <div class="card-box height-100-p pd-20 min-height-200px">
        <div class="d-flex justify-content-between">
            <div class="h5 mb-0">Customers</div>
            <div class="table-actions">
                <a title="VIEW" href="customer.php"><i class="icon-copy ion-disc" style="color: #17a2b8;"></i></a>
            </div>
        </div>
        ...
        <div class="user-list">
            <ul>
                <?php
                $query = mysqli_query($conn, "SELECT * FROM customer_details ORDER BY customer_id DESC LIMIT 4") or die(mysqli_error());
                while ($row = mysqli_fetch_array($query)) {
                    $id = $row['customer_id'];
                ?>
                    <li class="d-flex align-items-center justify-content-between">
                        <div class="name-avatar d-flex align-items-center pr-2">
                            ...
                            <div class="txt">
                                <span class="badge badge-pill badge-sm" style="background-color: #e7ebf5; color: #265ed7;"><?php echo $row['vehicle_type']; ?></span>
                                <div class="font-14 weight-600"><?php echo $row['customer_name']; ?></div>
                                <div class="font-12 weight-500" style="color: #b2b1b6;"><?php echo $row['service_type']; ?></div>
                            </div>
                        </div>
                        <div class="font-12 weight-500" style="color: #17a2b8;"><?php echo $row['customer_phone']; ?></div>
                    </li>
                <?php } ?>
            </ul>
        </div>
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="customers-tab" data-toggle="tab" href="#customers" role="tab" aria-controls="customers" aria-selected="true"> <b>CUSTOMERS</b></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="staff-tab" data-toggle="tab" href="#staff" role="tab" aria-controls="staff" aria-selected="false"><b>STAFFS PERMISSIONS</b></a>
        </li>
    </ul>
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="customers" role="tabpanel" aria-labelledby="customers-tab">
            <div class="card-box mb-30">
				 ...
				 <!-- <div class="pd-20">
                <h2 class="text-blue h2">All Customers</h2>
            </div> -->
            <div class="pb-20">
        ...
        <div class="tab-pane fade" id="staff" role="tabpanel" aria-labelledby="staff-tab">
            <div class="card-box mb-30">
				 ...
				 <!-- <div class="pd-20">
                <h2 class="text-blue h4">Staff permissions</h2>
            </div> -->
            <div class="pb-20">
                <table class="data-table table stripe hover nowrap">
                    <thead>
