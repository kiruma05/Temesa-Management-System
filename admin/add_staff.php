...
<?php
	...
	<?php
        ...
        mysqli_query($conn,"INSERT INTO tblemployees(FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,Av_leave,role,Phonenumber,Status, location) VALUES('$fname','$lname','$email','$password','$gender','$dob','$department','$address','$available_days','$user_role','$phonenumber','$status', 'NO-IMAGE-AVAILABLE.jpg')         
		") or die(mysqli_error()); ?>
						...
						<form method="post" action="">
							<section>
								...
								<div class="row">
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											<label>Staff available Days :</label>
											<input name="available_days" type="number" class="form-control" required="true" autocomplete="off">
										</div>
									</div>
