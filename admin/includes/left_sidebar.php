...
<div class="brand-logo">
			...
			<img src="../vendors/images/logo-temesa.PNG" alt="" class="dark-logo">
				<img src="../vendors/images/logo-temesa.PNG" alt="" class="light-logo">
			</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li>
						<a href="leave_type.php" class="dropdown-toggle no-arrow">
							<span class="micon dw dw-calendar1"></span><span class="mtext"> Service Type </span>
						</a>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-library"></span><span class="mtext"> Customers </span>
						</a>
						<ul class="submenu">
							<li><a href="add_customerr.php"> New Customers </a></li>
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							...
							<li><a href="cust.php"> Manage Staff </a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-apartment"></span><span class="mtext"> Services </span>
						</a>
						<ul class="submenu">
							
							<li><a href="leaves.php"> All Services </a></li>
							<li><a href="pending_leave.php"> Pending Services </a></li>
							<li><a href="approved_leave.php"> Approved Services </a></li>
							<li><a href="rejected_leave.php"> Rejected Services </a></li>
						</ul>
					</li>
