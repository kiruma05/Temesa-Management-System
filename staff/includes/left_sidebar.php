		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-apartment"></span><span class="mtext"> Dilay Work </span>
						</a>
						<ul class="submenu">
							<li><a href="apply_leave.php">Work Tittle</a></li>
							<li><a href="leave_history.php">Work Discription</a></li>
